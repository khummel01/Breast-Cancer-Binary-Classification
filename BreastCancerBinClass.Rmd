...
```{r}
#todo: take out most highly correlated predictors, save for one
#todo: explain why perimeter_mean, se, worst and area_mean, se, worst were taken out
...
cancer2$radius_mena.c = my.center (cancer2$radius_mean)
cancer2$texture_mean.c = my.center (cancer2$texture_mean.c)
cancer2$perimeter_mean.c = my.center (cancer2$perimeter_mean.c)
cancer2$smoothness_mean.c = my.center (cancer2$smoothness_mean.c)
cancer2$pH.c = my.center (cancer2$pH)
cancer2$sulphates.c = my.center (cancer2)
cancer2$alcohol.c = my.center (cancer2$alcohol)
attach(cancer2)
