...
#Celia
par (mfrow=c(1,1))
pred1 <- prediction(m.both$fitted.values, m.both$y) ## change to stepwise results
perf1 <- performance(pred1,"tpr","fpr")
auc1 <- performance(pred1,"auc")@y.values[[1]]
auc1
